...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?= $this->include('layout_backend/header') ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?= $this->include('layout_backend/topbar') ?>

                <!-- Begin Page Content -->
                <div class="container-fluid">

                    <!-- Page Heading -->
                    <?= $this->renderSection('content_backend') ?>
           ...
           <?= $this->include('layout_backend/footer') ?>
    ...
    <?= $this->include('layout_backend/logout') ?>
