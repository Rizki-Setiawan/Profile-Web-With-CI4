...
<div class="container">
    ...
    <?php endif; ?>
    <form method="post" action="<?= base_url('backend/berita/store'); ?>">
        <?= csrf_field(); ?>
        <div class="form-group">
            <label for="title">Author</label>
            <input type="text" name="author" class="form-control" value="<?= session()->get('name'); ?>" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
           ...
           <textarea name="content" id="editor" class="form-control" cols="30" rows="10" placeholder="Konten Berita" ></textarea>
       </div>
